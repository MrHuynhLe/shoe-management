...
public class DiscountController {
    ...
    public ResponseEntity<ValidateDiscountResponse> validate(@Valid @RequestBody ValidateDiscountRequest request, @AuthenticationPrincipal CustomUserDetails userDetails) {

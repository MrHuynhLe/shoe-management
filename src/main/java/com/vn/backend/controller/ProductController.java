...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getProductsByStatus(@PathVariable Boolean isActive) {
        return ResponseEntity.ok(productService.getProductsByStatus(isActive));
    }
